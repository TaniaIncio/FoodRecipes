...
public class RecipeAppWidget extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.widget_grid_view);//recipe_app_widget
        ...
        wateringIntent.setAction(RecipeWIdgetService.ACTION_RECIPE );
